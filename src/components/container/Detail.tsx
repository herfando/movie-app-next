  ...
  return (
    <section className="bg-black w-full md:h-[1383px] h-[1345px] flex items-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-1">
          <div className="gap-5 grid content-start md:translate-x-80 translate-x-35">
            ...
            <div className="items-center flex md:gap-2 gap-1 text-xs content-center">
              ...
              <span className="text-white">12 Februari 2025</span>
            </div>
            {/* Watch Trailer */}
            <div className="flex items-center  gap-3">
              ...
              <div className="md:flex hidden content-center md:w-[52px] md:h-[52px] w-[44px] h-[44px] border rounded-full justify-center items-center border-[#181D27] bg-[#181D27]">
                <Heart className="w-[24px] h-[24px] stroke-white fill-none md:stroke-[#961200] md:fill-[#961200]"></Heart>
              </div>
            </div>
          </div>
          {/* Watch Trailer */}
      ...
      <div className="absolute md:translate-y-45 translate-y-17 md:translate-x-20 translate-x-5 md:mr-40 mr-10">
        ...
        <span className="text-[#A4A7AE] text-l">
      ...
      <div className="absolute md:translate-y-115 translate-y-105 md:translate-x-20 translate-x-5">
        ...
        <div className="grid md:grid-cols-3 grid-cols-1  md:gap-15 gap-2">
          ...
          <div className="flex gap-4">
            ...
            <h4 className="gap-2 grid content-center text-white">
              Harrison Ford
              <span className="text-[#A4A7AE]">President Thaddeus Ross</span>
            </h4>
          </div>
          <div className="flex gap-4">
            <Image
            ...
            <h4 className="gap-2 grid content-center text-white">
              Danny Ramirez
              <span className="text-[#A4A7AE]">Joaquin Torres</span>
            </h4>
          </div>
          <div className="flex gap-4">
            <Image
            ...
            />
            <h4 className="gap-2 grid content-center text-white">
              Shira Haas<span className="text-[#A4A7AE]">Ruth Bat-Seraph</span>
            </h4>
          </div>
          <div className="flex gap-4">
            <Image
            ...
            <h4 className="gap-2 grid content-center text-white">
              Tim Blake Nelson
              <span className="text-[#A4A7AE]">Samuel Sterns</span>
            </h4>
          </div>
        </div>
      </div>
