        ...
        <div className="absolute flex md:translate-x-20 translate-x-5 gap-10 md:-translate-y-30 -translate-y-70">
          ...
          <div className="grid grid-cols-1">
            ...
            <div className="flex items-center gap-3 translate-y-20">
              <form className="md:hidden flex text-white h-[44px] w-[250px] justify-center items-center md:h-[52px] md:w-[230px] relative rounded-full bg-[#961200]">
                <button type="submit">Watch Trailer</button>
                  <Image src="/Play.png" alt="vektor" className="pl-2" width={30} height={30} />
                </form>
            ...
            <div className=" text-white gap-10 flex mt-5 translate-x-80">
              <div className="rounded-2xl flex flex-col gap-2 content-center md:w-[276px] md:h-[146px] w-[112px] h-[120px] bg-[#000000] justify-center items-center"> <Star className="stroke-[#E4A802] fill-[#E4A802]"/>Rating <span>6.2/10</span> </div>
              <div className="rounded-2xl flex flex-col gap-2 content-center md:w-[276px] md:h-[146px] w-[112px] h-[120px] bg-[#000000] justify-center items-center"> <Video className="stroke-white fill-white"/>Genre <span>Action</span> </div>
              <div className="rounded-2xl flex flex-col gap-2 content-center md:w-[276px] md:h-[146px] w-[112px] h-[120px] bg-[#000000] justify-center items-center"> <Image src="/Vector4.png" alt="agelimit" width={26.65} height={26.67}/>Age Limit<span>13</span> </div>       
            </div>
          </div>
        </div>
