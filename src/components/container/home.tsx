  ...
  return (
    <>
      <div className="relative w-full overflow-hidden">
        ...
        {/* Navigation */}
        <nav className="bg-amber-300 w-full sm:h-[90px] h-[64px] mx-auto grid grid-cols-2 sm:grid-cols-3 justify-between items-center">
          {/* Movie */}
          <div className=" bg-amber-800 flex flex-1 gap-3 justify-start items-center">
          ...
          <div className="bg-amber-700 sm:hidden flex flex-1 justify-end items-center gap-4">
